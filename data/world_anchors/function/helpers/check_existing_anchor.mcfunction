...
execute if score @s debug_active matches 1 run tellraw @s [{"text":"Check Existing ", "color":"aqua"}, {"score":{"name":"@s","objective":"existing_anchor","color":"green"}}]
...
$execute if data storage world_anchors:log_list entries[{name:'$(name)'}] run scoreboard players set @s existing_anchor 1
